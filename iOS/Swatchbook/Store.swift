...
final class Store: ObservableObject {
    ...
    private let fileName = "swatchbook_entries.json"
    ...
    static func seedData() -> [Entry] {
        let now = Date()
        return [
            Entry(title: "Sample Swatch One", detail: "First example entry.", date: now),
            Entry(title: "Sample Swatch Two", detail: "Second example entry.", date: now.addingTimeInterval(-86400)),
            Entry(title: "Sample Swatch Three", detail: "Third example entry.", date: now.addingTimeInterval(-172800)),
        ]
    }
}
